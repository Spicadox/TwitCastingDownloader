...
A CLI program that can grab all video links and its respective m3u8 file from a TwitCasting channel. This program only supports VODs, and will not work with live streams. It can grab either videos from "shows" or "showclips".
